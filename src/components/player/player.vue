  ...
  methods: {
    ...
    prev() {
      ...
      if (this.playlist.length === 1) {
        ...
        if (this.currentSong.url !== this.url) {
    ...
    middleTouchMove(e) {
      ...
      this.$refs.lyricList.$el.style[transitionDuration] = null;
      this.$refs.cdWrapper.style[transitionDuration] = null;
    ...
    format(num) {
      ...
      const second = this._pad(Math.floor(num % 60));
